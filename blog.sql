...
CREATE TABLE `blog_comment` (
  ...
  KEY `FKgs990mxmxbqlh7d0urbdjd0h7` (`blog_id`),
  CONSTRAINT `FKc4ysudanwhfrrhytio0272sx9` FOREIGN KEY (`comment_id`) REFERENCES `comment` (`id`),
  CONSTRAINT `FKgs990mxmxbqlh7d0urbdjd0h7` FOREIGN KEY (`blog_id`) REFERENCES `comment` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', null, 'admin@giteasy.cn', '阿信', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', 'admin');
INSERT INTO `user` VALUES ('2', null, 'axin@giteasy.cn', 'axin', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVKIUi', 'axin');
